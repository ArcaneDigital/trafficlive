  ...
  this.api = {
    employees: {
      ...
      find: function (filter, callback) {
        self.filter = filter;
        return self.request(rest.get, `/staff/employee/?windowSize=${self.pageSize}&filter=${filter}`, {}, function (result) {
          callback(result);
        });
      },
      tasks: function (id, callback) {
        return self.request(rest.get, `/staff/employee/${id}/jobtaskallocations`, {}, function (result) {
          callback(result);
        });
      },
    ...
    chargebands: {
      ...
      one: function (id, callback) {
        return self.request(rest.get, '/chargeband/'+id, {}, function (result) {
          callback(result);
        });
      }
    },
    departments: {
      all: function (callback) {
        return self.request(rest.get, '/staff/department', {}, function (result) {
          callback(result);
        });
      },
      one: function (id, callback) {
        return self.request(rest.get, '	/staff/department/'+id, {}, function (result) {
          callback(result);
        });
      }
    },
    ...
    allocations: {
      ...
      find: function(filter, callback){
        ...
        return self.request(rest.get, `/timeallocations/jobtasks/?windowSize=${self.pageSize}&filter=${self.filter}`, {}, function(result){
          callback(result);
        });
      },
    },
    entries: {
      ...
      recent: function(callback){
        return self.request(rest.get, '/timeentries', {startDate: '2016-02-01'}, function(result){
          callback(result);
        });
      },
      find: function (start, end, filter, callback) {
      ...
      one: function(id, callback){
        return self.request(rest.get, '/timeentries/'+id, {}, function(result){
          callback(result);
        });
      }
    },
    lists: {
      items: function(type, callback){
        return self.request(rest.get, '/listitem/'+type, {}, function(result){
          callback(result);
        });
      }
    },
